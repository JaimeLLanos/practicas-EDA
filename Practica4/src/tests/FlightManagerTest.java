...
class FlightManagerTest {
    ...
    private IFlight newFlight(String company, int flightCode, int year, int month, int day){
        //TODO: Llamad vuestra clase vuelo "Flight" y que tenga un constructor vacio.
        //Si le habeis dado otro nombre a la clase vuelo, no lo cambieis manualmente.
        //Utilizad las opciones para refactorizar codigo que trae cualquier IDE.
    ...
    private IPassenger newPassenger(String dni, String name, String surname){
        //TODO: Llamad vuestra clase pasajero "Passenger" y que tenga un constructor vacio.
    ...
    void addFlight() {
        IFlight flight = manager.addFlight(companies.get(0), 1200, 2018, 12, 20);
    ...
    void getFlight() {
        ...
        IFlight flight1 = manager.getFlight(companies.get(0), 1200, 2018, 12, 20);
        ...
        IFlight flight2 = manager.getFlight(companies.get(0), 1200, 2018, 12, 20);
    ...
    void updateFlight_identifiers() {
        ...
        manager.updateFlight(companies.get(0), 1200, 2018, 12, 20, flight1);
        IFlight flightUpdated = manager.getFlight(companies.get(5), 704, 2018, 12, 20);
    ...
    void addPassenger() {
        manager.addFlight(companies.get(0), 1200, 2018, 12, 20);
        IFlight flight = manager.getFlight(companies.get(0), 1200, 2018, 12, 20);
    ...
    void getPassengers() {
        ...
        Iterable<IPassenger> passengers = manager.getPassengers(companies.get(0), 1200, 2018, 12, 20);
        List<IPassenger> list = getSortedPassengers(passengers);
    ...
    void getPassengers_afterUpdate() {
        ...
        Iterable<IPassenger> passengers = manager.getPassengers(companies.get(0), 1408, 2018, 12, 22);
        List<IPassenger> list = getSortedPassengers(passengers);
        String expected = "[09409833G A A, 10 C Y, 10202761F B X]";
        assertEquals(expected, list.toString());
    }
    ...
    void flightsByDate() {
        ...
        Iterable<IFlight> flightsByDate = manager.flightsByDate(2020, 1, 31);
        List<IFlight> list = getSortedFlightsAsList(flightsByDate);
        assertEquals(0,list.size());
    ...
    void flightsByDate_AfterUpdate() {
        ...
        IFlight flight = manager.getFlight(companies.get(0), 7070, 2019, 1, 31);
        ...
        list = getSortedFlightsAsList(flightsByDate);
        assertEquals(1,list.size());
        expected =  "[31-1-2020\tIBE7070\t8:15\tMadrid-Barajas Adolfo Suárez (MAD)\tLISBOA (LIS)]";
        assertEquals(expected, list.toString());
    ...
    void getFlightsByPassenger() {
        ...
        IFlight flight1 = manager.getFlight(companies.get(0), 7070, 2019, 1, 31);
        flight1.setCapacity(10);
        manager.updateFlight(companies.get(0), 7070, 2019, 1, 31, flight1);

        IFlight flight2 = manager.getFlight(companies.get(0), 7070,2019,2,11);
        flight2.setCapacity(10);
        manager.updateFlight(companies.get(0), 7070,2019,2,11, flight2);

        IFlight flight3 = manager.getFlight(companies.get(2), 9070,2019,1,12);
        ...
        IPassenger p1 = newPassenger("09409833G", null, null);
        IPassenger p2 = newPassenger("10202761F", null, null);
        IPassenger p3 = newPassenger("10", null, null);

        Iterable<IFlight> flightsByPassenger = manager.getFlightsByPassenger(p1);
        List<IFlight> list = this.getSortedFlightsAsList(flightsByPassenger);
        assertEquals(3,list.size());
        ...
        IPassenger pUnknown = newPassenger("0", null, null);
    ...
    void getFlightsByPassenger_AfterUpdate() {
        ...
        IPassenger p1 = newPassenger("10202761F", null, null);
    ...
    void getFlightsByDestination() {
        ...
        IFlight f1 = manager.getFlight(companies.get(0), 7070, 2019, 1, 31);
        IFlight f2 = manager.getFlight(companies.get(1), 7071,2019,1,31);
        IFlight f3 = manager.getFlight(companies.get(2), 7070,2019,2,11);
        IFlight f4 = manager.getFlight(companies.get(3), 8072,2019,2,11);
        IFlight f5 = manager.getFlight(companies.get(4), 9070,2019,2,12);
        IFlight f6 = manager.getFlight(companies.get(5), 9070,2019,2,13);
        ...
        Iterable<IFlight> flights = manager.getFlightsByDestination(airport.get(2), 2019, 1, 31);
        List<IFlight> list = this.getSortedFlightsAsList(flights);
        assertEquals(2,list.size());
    ...
    void getFlightsByDestination_AfterUpdate() {
        ...
        Iterable<IFlight> flights = manager.getFlightsByDestination(airport.get(1), 2019, 2, 13);
        List<IFlight> list = this.getSortedFlightsAsList(flights);
        assertEquals(1,list.size());
    ...
    private ArrayList<IPassenger> getSortedPassengers(Iterable<IPassenger> passengers) {
        ArrayList<IPassenger> list = new ArrayList<>();
    ...
    private List<IFlight> getSortedFlightsAsList(Iterable<IFlight> flights) {
