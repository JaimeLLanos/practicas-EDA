...
public class AVLTree<E> implements BinarySearchTree<E> {
    ...
    public Iterable<Position<E>> findRange(E minValue, E maxValue) throws RuntimeException{
    	...
    	while(it.hasNext()) {
    		...
    		e = this.checkPosition(aux);
    		comp1 = e.compareTo((AVLTree<E>.AVLInfo<E>) minValue);
    		comp2 = e.compareTo((AVLTree<E>.AVLInfo<E>) maxValue);
    		if((comp1 <= 0) && (comp2 > 0)) {
    			List.add(aux);
    		}
    	}
    ...
    public Position<E> first() throws RuntimeException {
    	return (Position<E>) this.bst.first();
    }
    
    public Position<E> last() throws RuntimeException {
    	return (Position<E>) this.bst.last();
    }
    ...
    public Iterable<Position<E>> successors(Position<E> pos){
    	...
    	while(it.hasNext()) {
    		aux = (Position<E>) it.next();
    		e = this.checkPosition(aux);
    		comp = e.compareTo((AVLTree<E>.AVLInfo<E>) pos);
    		if(comp <= 0) {
    			List.add(aux);
    		}
    	}
