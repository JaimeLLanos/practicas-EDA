...
import material.usecase_p5.Flight;
import material.usecase_p5.FlightQuery;
import material.usecase_p5.IFlight;
...
class FlightQueryTest {
    ...
    IFlight newFlight(){
        //TODO: Constructor de vuestra clase.
        //Es la misma clase que hayais creado para la practica de mapas,
        //y el comportamiento de toString() es el mismo que se pedia
        // en ella.
        IFlight f = new Flight();
        return f;
    }

    IFlight newFlight(String company, int flightCode, int year, int month, int day, String destination){
        IFlight f = newFlight();
    ...
    void searchByDates() {
        ...
        Iterable<IFlight> output;
        String expected;
        IFlight f1 = newFlight(companies.get(1),770,2018,12,6, airport.get(5));
        IFlight f2 = newFlight(companies.get(1),730,2018,12,7, airport.get(8));
        IFlight f4 = newFlight(companies.get(1),730,2018,12,12, airport.get(8));
        IFlight f3 = newFlight(companies.get(1),770,2018,12,31, airport.get(5));

        IFlight f5 = newFlight(companies.get(2),340,2016,12,31, airport.get(6));
        IFlight f6 = newFlight(companies.get(2),340,2018,6,30, airport.get(6));
        IFlight f7 = newFlight(companies.get(2),350,2018,4,17, airport.get(7));
        IFlight f8 = newFlight(companies.get(2),350,2018,12,7, airport.get(7));

        IFlight f9 = newFlight(companies.get(3),401,2018,12,7, airport.get(4));
        IFlight f10 = newFlight(companies.get(3),402,2018,12,7, airport.get(12));
        IFlight f11 = newFlight(companies.get(3),403,2019,12,7, airport.get(13));
        IFlight f12 = newFlight(companies.get(3),413,2011,1,7, airport.get(14));
    ...
    void searchByDestinations() {
        ...
        IFlight f9 = newFlight(companies.get(3),401,2018,12,7, airport.get(8));
        IFlight f10 = newFlight(companies.get(3),402,2018,12,7, airport.get(9));
        IFlight f11 = newFlight(companies.get(3),403,2019,12,7, airport.get(10));
        IFlight f12 = newFlight(companies.get(3),413,2011,1,7, airport.get(11));
    ...
    private String iterableToString(Iterable<IFlight> iterable){
        StringBuilder sb = new StringBuilder("[");
        for (IFlight f: iterable){
